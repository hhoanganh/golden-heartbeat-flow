...
import { User, Edit2, LogOut, Stethoscope, CheckCircle, Shield } from 'lucide-react';
...
const MedicalProfileSection = () => {
  ...
  const [formData, setFormData] = useState({
    fullName: 'Dr. Le Van Duc',
    dateOfBirth: '1985-08-12',
    workEmail: 'dr.le.van.duc@medical.vn',
  ...
  const professionalInfo = {
    assignedCenter: 'Cho Ray Hospital Blood Bank',
    specialization: 'Hematology Consultant',
    licenseNumber: 'MD2024007',
    accessLevel: [
      'Review Health Declarations',
      'Approve/Defer Donors',
      'Access Full Medical History',
      'Input Screening Results',
      'View Donor Medical Records'
    ]
  };
            ...
            <div className="lg:col-span-1 space-y-l">
              ...
              <Card>
                <CardContent className="p-m text-center">
                  ...
                  <Badge variant="default" className="mb-2 bg-supportive-blue">Medical Professional</Badge>
                  <p className="text-caption text-gentle-gray">License: {professionalInfo.licenseNumber}</p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-body text-deep-gray">{professionalInfo.assignedCenter}</p>
                  </div>
                  <div className="space-y-2">
                    <Label className="text-body font-medium">Specialization</Label>
                    <p className="text-body text-deep-gray">{professionalInfo.specialization}</p>
                  </div>
                  <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      {professionalInfo.accessLevel.map((access, index) => (
                        <div key={index} className="flex items-center space-x-2">
                          <CheckCircle className="h-4 w-4 text-harmony-green" />
                          <span className="text-body text-deep-gray">{access}</span>
                        </div>
                      ))}
                    </div>
                  </div>
