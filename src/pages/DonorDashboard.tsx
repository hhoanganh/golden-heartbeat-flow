  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex flex-col md:flex-row"> {/* Changed to flex-col on mobile, flex-row on md and up */}
        ...
        {/* Main Content */}
        {/* Added pb-20 to ensure content is not hidden behind the fixed bottom navigation */}
        <div className="flex-1 p-4 md:p-8 pb-20">
          {renderContent()}
        </div>

        {/* Mobile Bottom Navigation */}
        {/* This component will only be visible on mobile screens (hidden on md and up) */}
        <MobileBottomNav
          menuItems={menuItems}
